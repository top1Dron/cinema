...
function deleteImage(button, form_ind){
    ...
    if (url != null){
        $.ajax({
            ...
            success: function(resp){
                $(`#id_advertise_page-${form_ind}-DELETE`).attr('checked', true);
    ...
    $('#id_advertise_page-TOTAL_FORMS').val($('#id_advertise_page-TOTAL_FORMS').val() - 1);
    $('.card.ms-2').matchHeight();    
}
